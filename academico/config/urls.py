...
urlpatterns = [
    ...
    path('avaliacao/', avaliacoes, name='avaliacao'),
    path('pessoas/', pessoas, name ='pessoas'),
    path('ensino/', ensino, name ='ensino'),
    path('areas/', areas, name ='areas'),
    path('cursos/', cursos, name ='cursos'),
    path('semestres/', semestres, name ='semestres'),
    path('diciplina/', diciplina, name ='diciplina'),
    ...
    path('diciplinacurso/', diciplinacurso, name ='diciplinacurso'),
]
